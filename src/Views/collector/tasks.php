<!-- <div class="header">
  ...
  <!-- Start Task Button -
  <button class="start-btn" onclick="startTask('journey.html')">
    <i class="fa-solid fa-play"></i> Start Task
  </button>

  <!-- Navigate Button -
  <button class="nav-btn" onclick="navigateToMap('123 Oak Street')">
    <i class="fa-solid fa-location-arrow"></i> Navigate
  </button>
</div>

<script>
  // Redirect to "Journey Starts" page with confirmation
  function startTask(url) {
    alert("Your journey has started! 🚀");
    window.location.href = url; // redirect to journey.html or any route
  }

  // Open Google Maps with given address
